...
import CustomerMyClaims from './components/customer/CustomerMyClaims'
import MakePayment from './components/payment/MakePayment'
import ViewPolicy from './components/policy/ViewPolicy'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path = "/addPolicyAddOns" element = {<AddPolicyAddOns />} />
        <Route path = "/admin/customers" element = {<ViewCustomer />} />
        ...
        <Route path = "/admin/makePayments" element = {<MakePayment />} />
        ...
        <Route path = "/addClaim" element = {<CustomerAddClaim />} />
        <Route path = "/myClaim" element = {<CustomerMyClaims />} />
